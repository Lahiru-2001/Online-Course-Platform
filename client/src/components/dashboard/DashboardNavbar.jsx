    ...
    <header className="dashboard-navbar">
      ...
      <div className="navbar-left">
        ...
        <ul className="navbar-links">
          ...
          <li><a href="#" className={activeTab === 'Courses' ? 'active' : ''}>Courses</a></li>
          <li><a href="#" className={activeTab === 'Reports' ? 'active' : ''}>Reports</a></li>
          <li><a href="#" className={activeTab === 'Users' ? 'active' : ''}>Users</a></li>
        </ul>
      </div>
      ...
      <div className="navbar-right">
        ...
        {/* Notification Icon */}
        <button className="icon-btn" aria-label="Notifications" onClick={() => console.log('Notifications clicked')}>
        ...
        {/* Settings Icon */}
        <button className="icon-btn" aria-label="Settings" onClick={() => console.log('Settings clicked')}>
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        {/* User Avatar */}
        <div className="user-avatar" role="button" tabIndex="0" onClick={() => console.log('Profile clicked')}>
