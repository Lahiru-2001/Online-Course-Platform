        ...
        <ul className="nav-list">
          <li className="nav-item">
            <a 
              ...
              onClick={(e) => handleNavClick(e, 'Overview', '/dashboard')}
            >
          ...
          <li className="nav-item">
            <a 
              ...
              onClick={(e) => handleNavClick(e, 'Courses', '/admin/courses')}
            >
          ...
          <li className="nav-item">
            <a 
              href="#" 
              className={`nav-link ${activeTab === 'Progress Tracking' ? 'active' : ''}`}
              onClick={(e) => handleNavClick(e, 'Progress Tracking', '/admin/reports')}
            >
          ...
          <li className="nav-item">
            <a 
              ...
              onClick={(e) => handleNavClick(e, 'Enrollments', '/admin/users')}
            >
          ...
          <li className="nav-item">
            <a 
              ...
              onClick={(e) => handleNavClick(e, 'Earnings', '/admin/earnings')}
            >
          ...
          <li className="nav-item">
            <a 
              ...
              onClick={(e) => handleNavClick(e, 'Admin Panel', '/admin/users')}
            >
        ...
        <ul className="nav-list">
          <li className="nav-item">
            <a 
              href="#" 
              className="nav-link"
              onClick={(e) => handleNavClick(e, 'Settings', '/admin/settings')}
            >
